...
import { Avatar, Box, Button, Divider, Flex, HStack, Heading, Icon, Image, Input, Switch, Text, VStack, Slider, SliderTrack, SliderFilledTrack, SliderThumb, SliderMark, } from '@chakra-ui/react'
...
import { AiFillFileText, AiOutlineArrowLeft, AiOutlineClockCircle, AiOutlineMail, AiOutlineWifi } from 'react-icons/ai'
...
const AppSetting = () => {
    ...
    return (
        <Box w={'100%'} px={8} mx={8}>
            ...
            <Heading mb={8} fontWeight={'semibold'} size={'lg'}>About</Heading>
            ...
            <Heading mb={8} fontWeight={'semibold'} size={'lg'}>Video Playback</Heading>
            <HStack mb={2} spacing={4}>
                <svg style={{ width: 24, height: 24 }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1d8780"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#fffCCCCCC" stroke-width="0.096"></g><g id="SVGRepo_iconCarrier"> <path d="M16.2426 7.75738C18.5858 10.1005 18.5858 13.8995 16.2426 16.2427M7.75736 16.2426C5.41421 13.8995 5.41421 10.1005 7.75736 7.75735M4.92893 19.0711C1.02369 15.1658 1.02369 8.8342 4.92893 4.92896M19.0711 4.929C22.9763 8.83424 22.9763 15.1659 19.0711 19.0711M14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12C10 10.8955 10.8954 10 12 10C13.1046 10 14 10.8955 14 12Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                <Text fontSize={'1.2rem'}>Cellular data usage</Text>
            </HStack>

            <Divider my={8} />

            <Heading mb={8} fontWeight={'semibold'} size={'lg'}>Downloads</Heading>
            <HStack w={'30%'} justifyContent={'space-between'} mb={2} spacing={4}>
                <AiOutlineWifi size={28} />
                <Text w={'100%'} textAlign={'start'} color={'white'}>Wifi Only</Text>
                <Switch colorScheme='customGreen' />
            </HStack>
            <HStack w={'30%'} justifyContent={'space-between'} mb={2} spacing={4}>
                <BsDownload size={28} />
                <Text w={'100%'} color={'white'}>Download next episode</Text>
                <Switch colorScheme='customGreen' />
            </HStack>
            <HStack mb={2} spacing={4}>
                <BiNews size={24} />
                <Text w={'100%'} color={'white'}>Video Quality</Text>
            </HStack>

            <ResolutionSlider />

            <Divider my={8} />
            <Button size={'lg'} bg={'transparent'} color={'red'} leftIcon={<HiTrash color='red' />} >Delete Downloads</Button>
        </Box>
    )
}
    ...
    return (
        <Box w={'100%'} px={8} mx={8}>
            ...
            <HStack justifyContent={'flex-end'}>
                ...
                <Button px={16} variant={'outline'}>Live Chat</Button>
            </HStack>
        </Box>
    );
}
                ...
                return (
                    <div style={{ width: '100%' }}>
                        ...
                        <HStack w={'40%'} justifyContent={'space-between'}>
                            <Text fontWeight={'semibold'} color={'white'}>Content Creator</Text>
                            <Text color={'white'} textAlign={'start'}>  {plan.contentcreator}</Text>
                        </HStack>
                        <HStack w={'40%'} justifyContent={'space-between'}>
                            <Text fontWeight={'semibold'} color={'white'}>Plan</Text>
                            <Text color={'white'} textAlign={'start'}>  ${plan.price} / month</Text>
                        </HStack>
                        <HStack w={'40%'} justifyContent={'space-between'}>
                            <Text fontWeight={'semibold'} color={'white'}> Billing Date</Text>
                            <Text color={'white'} textAlign={'start'}>  {plan.start_date}- {plan.end_date}</Text>
                        </HStack>
    ...
    return (
        <Box w={'100%'}>
            ...
            <Flex justifyContent={'center'}>
                <Button px={16} fontSize={'1.2rem'}>Cancel Membership</Button>
            </Flex>
        </Box >
    );
}
...
const Membership = () => {
    ...
    const ActivityOutline = ({ access }) => (
        <Box my={4} borderRadius={8} p={8} bg={'#232323'}>
            ...
            <HStack>
                ...
                <Text> Last watch {access.accessDate}. {access.accessTime}</Text>
            </HStack>
            <HStack>
    ...
    return (
        <Box w={'100%'}>
            ...
            <Divider my={8} />
            <Box my={8}>
                <Heading mb={2} size={'md'}>Manage and access devices</Heading>
                <Text>These signed- in devices have recently been active on this account. you can sign out any  un-familiar or <a style={{ color: '#55DF01' }}>change your password</a> for added security.</Text>
            </Box>
...
const Settings = () => {
    ...
    return (
        <Box w={'100%'}>
            ...
            <Divider my={8} />
            <Box my={8}>
                <Heading mb={2} size={'md'}>Manage download devices</Heading>
                <Text>Your plan allows downloads on 2 devices. when you remove a device, all downloads.</Text>
            </Box>
...
const Delete = () => {
    return (
        <Box w={'100%'}>
            ...
            <HStack spacing={4} my={4} borderRadius={8} p={2} border={'1px solid #9c9c9c'}>
...
const TermsConditions = () => {
    return (
        <Box w={'100%'}>
            ...
            <Divider my={4} />
            <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium metus. Nam eget urna tortor. Vivamus molestie malesuada blandit. Nunc ut nulla nec nulla finibus commodo. Sed utmalesuad tellus. Ut et tempor odio, ac gravida dolor. Donec bibendum porttitor ante. Maecenas in congue metus. Donec in massa purus. Fusce scelerisque orci non elementum bibendum. Morbi et varius orci, nec hendrerit lectus.</Text>
            <br />
            <Text>Donec enim nibh, mollis sed convallis eu, cursus ut ante. Sed condimentum convallis lacinia. Praesent luctus luctus diam, a vestibulum elit euismod eget. Nullam vel commodo risus. Praesent auctor nibh ut tincidunt dapibus.</Text>
        </Box>
    );
}
            ...
            <Box px={16} py={8} >
                ...
                <HStack mx={16} spacing={16}>
                    {userDetails.map((user, index) => (
                        <VStack h={'100%'} spacing={4} alignItems={'center'} justifyContent={'center'}>
                            <Avatar size={'2xl'} src='/assests/People/cena.jpg' />
                            <Text mt={4} textAlign={'center'}>{user.name}</Text>
                        </VStack>
                    ))}
                    <VStack h={'100%'} spacing={4} alignItems={'center'} justifyContent={'center'}>
                ...
                <Flex>
                    ...
                    >
                        <VStack>
                            <Button onClick={() => setContent('Account')} bg={'black'} leftIcon={BiUser}>Account</Button>
                            <Button onClick={() => setContent('App Settings')} bg={'black'} leftIcon={FiSettings}>App Settings</Button>
                            <Button onClick={() => setContent('Help')} bg={'black'} leftIcon={BiHelpCircle}>Help</Button>
                            <Button onClick={() => setContent('Contact')} bg={'black'} leftIcon={MdCall}>Contact</Button>
                            <Button onClick={() => setContent('Sign out')} bg={'black'} leftIcon={BiExit}>Sign out</Button>
                        </VStack>
                    </Box>
