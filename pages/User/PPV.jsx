...
const PPVContent = () => {
    return (
        <Box p={0}>
            <Stack w={'100%'} my={8} direction={["column", "row"]} justifyContent={"space-evenly"}>
                <Box
                    mt={"2rem"}
                ...
                <VStack w={'100%'} display={['none', 'flex']} mt={8} ml={8} justifyContent={"flex-start"} alignItems={"flex-start"}>
                    <Text color={'white'}><b>Start Date: </b> {Liveshows[0].start_date}</Text>
                    <Text color={'white'}><b>Start Time:</b> {Liveshows[0].start_time}</Text>
                    <Text color={'white'}><b>End Date:</b> {Liveshows[0].end_date}</Text>
                    <Text color={'white'}><b>End Time:</b> {Liveshows[0].end_time}</Text>
                    <Text color={'white'}><b>Venue:</b> {Liveshows[0].venue}, {Liveshows[0].city} </Text>
                </VStack>
            ...
            <Text fontSize={'1.2rem'} my={4}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati animi, iusto expedita, id impedit aperiam inventore doloremque necessitatibus sunt autem sed. Corrupti sunt, expedita, natus eius maiores cum praesentium exercitationem vitae deleniti mollitia ab sint laudantium aliquid sapiente omnis quas possimus minus quibusdam doloribus in, animi consectetur voluptates debitis! Perferendis!</Text>

            <Text fontSize={'1.2rem'} color={'white'}><b>Contact Number:</b> {Liveshows[0].contact}</Text>
            <Text fontSize={'1.2rem'} color={'white'}><b>Price:</b> ${Liveshows[0].price} / seat</Text>

            <Button width={['100%', "auto"]} size={8} my={8} py={4} px={16}>Buy Ticket</Button>
        </Box>
    );
};
