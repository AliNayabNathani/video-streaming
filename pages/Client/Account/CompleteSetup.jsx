...
export default function CompleteSetup() {
  ...
  return (
    <MainTemplate>
      <Box mx={"20%"}>
        <Heading textAlign={"start"} size={"lg"}>
        ...
        <QuestionContainer>
          ...
          <Collapse in={isOpen} animateOpacity>
            ...
            Perspiciatis saepe voluptate, ipsa porro cumque dolorem eos.
            Corrupti ad minima, fugit alias voluptate quisquam quos pariatur
            harum. Blanditiis, eum. Velit, sapiente.
          </Collapse>
        </QuestionContainer>
        <QuestionContainer>
        ...
        <QuestionContainer>
          <Text fontSize={"md"} textDecor={"underline"}>
            If Individual
          </Text>
          <Stack
            width={"100%"}
          ...
          <VStack width={"100%"} alignItems={"start"}>
            ...
            >
              <Checkbox mb={3} colorScheme="green">
                TAX info submitted immediately upon elec sign
              </Checkbox>
        ...
        <Text>
          ...
          quisquam iure laudantium delectus iste quis amet in mollitia placeat
          nobis. Ratione, rem obcaecati. Maiores neque recusandae temporibus,
          animi consequatur consequuntur facere atque dicta nesciunt quas,
          suscipit, hic porro cum. Esse architecto ipsa, facilis minima nulla
          perferendis eius asperiores similique nesciunt!
        </Text>
        <br />
        <Text mb={2} textDecor={"underline"}>
          Certification Instructions
        </Text>
        <Text>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorum non
          alias unde quam earum saepe fugit quod quibusdam, quia eius.
          Molestias, dicta unde reprehenderit dolore quidem iste dolorem nam
          facere consequatur sequi? Vitae voluptas reprehenderit illo
          consequuntur perspiciatis fugit numquam facilis laboriosam aut
          laudantium, magni a quos odit delectus voluptate.
        </Text>
        <br />
        ...
        />
        <Text mb={3}>
          By typing my name on given date, I am signing the TAX form under
        ...
        >
          ...
          <Button
            variant={"outline"}
            onClick={() => handleRoute("/Client/Signature")}
          >
            Submit for review
          </Button>
        </Stack>
