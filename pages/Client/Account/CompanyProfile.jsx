...
const StateDropdown = ({ stateValue, setStateValue }) => (
  <Menu>
    ...
    <MenuList onSelect={(value) => setStateValue(value)}>
      ...
      <MenuItem
        onClick={() => setStateValue("Los Angeles")}
        value="Los Angeles"
      >
        Los Angeles
      </MenuItem>
...
const CityDropdown = ({ cityValue, setCityValue }) => (
  <Menu>
    ...
    <MenuList onSelect={(value) => setCityValue(value)}>
      ...
      <MenuItem
        onClick={() => setCityValue("New York City")}
        value="New York City"
      >
        New York City
      </MenuItem>
...
export default function CompanyProfile() {
  ...
  return (
    <MainTemplate>
      ...
      <Text>
        Please enter your primary address wjere your company currently operates
      </Text>
      ...
      <Box border={"1px solid #55DF01"} p={4} borderRadius={"5px"}>
        <Text mb={"2rem"}>
          Please keep your company profile up-to-date. You must complete a
          company profile even if you`re not part of an organization. If you are
          setting up as an individual, enter your first and last name as the
          company name
        </Text>
        <Divider mb={"2rem"} />
        <Stack
        ...
        >
          <Box>
            <Heading color={"#55DF01"} size={"sm"}>
              Change Company Profile:{" "}
            </Heading>
            <Text>
              To make changes, click on the entry you want to change, and then
