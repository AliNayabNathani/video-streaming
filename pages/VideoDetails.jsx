import { Box, Divider, GridItem, HStack, Heading, Image, SimpleGrid, Stack, Text, VStack } from "@chakra-ui/react";
import { NormalHeading, PageHeading } from "../components/Admin/SmallReusableComponents/Heading";
import { Video, VideoPlayer } from "../components/Admin/SmallReusableComponents/VideoPlayer";
...
const VideoInfo = () => {
    return (
        <>
            <Stack mt={'2rem'} direction={['column', 'row']} width={'100%'} justifyContent={'space-evenly'} alignItems={'center'}>
