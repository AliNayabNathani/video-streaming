    ...
    return (
        <>
            <SimpleGrid
                ...
                borderRadius={5}
            >
                <Revenue_Card title="Total Revenue" total_earnings="$54000" weekly_earnings="$2000" />
                <Revenue_Card title="Sales Revenue" total_earnings="$33000" weekly_earnings="$1300" />
                <Revenue_Card title="Hub Revenue" total_earnings="$21000" weekly_earnings="$800" />
                <Stats_Card title="Total Users" total="15000" monthly="150" />
                <Stats_Card title="Total Content Creators" total="13000" monthly="130" />
