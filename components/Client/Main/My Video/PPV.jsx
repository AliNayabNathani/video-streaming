        ...
        {LiveData.map((live, index) => (
          ...
          >
            ...
            >
              ...
              <Text>
                Start Date: <b>{live.Start_Date}</b>
              </Text>
              <Text>
                End Date: <b>{live.End_Date}</b>
              </Text>
              <Text>
                Venue:{" "}
                <b>
                  {live.Venue}, {live.Country}
                </b>
              </Text>
              <Text>
                Contact Number: <b>{live.Contact}</b>
              </Text>
            </Stack>
            <Stack
              alignItems={"flex-start"}
            ...
            >
              <Text>
                Start Time: <b>{live.Start_Time}</b>
              </Text>
              <Text>
                End Time: <b>${live.End_Time}</b>
              </Text>
              <Text>
                Ticket: <b>{live.Price}$-seat</b>
              </Text>
            </Stack>

            <VStack justifyContent={"space-between"} spacing={"1rem"}>
              <Button w={"100%"}>Edit</Button>
              <Button variant={"outline"} w={"100%"} px={["auto", 8]}>
                Go Live
              </Button>
            </VStack>
          </Stack>
