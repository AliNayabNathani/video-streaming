import { Box, Collapse, Flex, FormLabel, Heading, Icon, Input, Menu, MenuButton, MenuItem, MenuList, Text, VStack, useDisclosure } from "@chakra-ui/react";
        ...
        <MainTemplate>
            <Box my={5} border={'2px solid #55DF01'} borderRadius={'10px'}>
                <VStack p={5} mx={5} alignItems={'start'}>
                    <Heading size={'md'} color={'#55DF01'}>Which Country do you live in?</Heading>
                    <Text>We need to know where you live so we can determine how to send you payments</Text>
                    <Menu>
                        <MenuButton color={''} w={['100%', '40%']} p={2} borderRadius={'5px'} bg={'#232323'}>
                        ...
                        <MenuList onSelect={(value) => setSelectedValue(value)}>
                            ...
                            <MenuItem onClick={() => setSelectedValue('Africa')} value="Africa">
                                Africa
                            </MenuItem>
